...
class main_module
{
	...
	{
		global $phpbb_container, $phpbb_admin_path;
	...
	public function main($id, $mode)
	{
		...
		$this->page_title = $this->language->lang('ACP_DMZX_NEWSLETTER_TITLE');
	...
	function email_member($member_id, $message, $title, $author, $url, $priority)
	{
		$sql = 'SELECT *
			FROM ' . USERS_TABLE . '
